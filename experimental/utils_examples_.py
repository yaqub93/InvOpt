...
def plot_results(results):
    ...
    if "theta_diff_hist" in results.keys():
        theta_diff_hist = results['theta_diff_hist']
    else: 
        theta_diff_hist = None

    if "x_diff_train_hist" in results.keys():
        x_diff_train_hist = results['x_diff_train_hist']
    else: 
        x_diff_train_hist = None

    if "x_diff_test_hist" in results.keys():
    ...
    if "obj_diff_train_hist" in results.keys():
        ...
        obj_diff_train_hist = None

    if "obj_diff_test_hist" in results.keys():
        obj_diff_test_hist = results['obj_diff_test_hist']
    else: 
        obj_diff_test_hist = None
    ...
    for a_index, approach in enumerate(approaches):
        ...
        if theta_diff_hist is not None:
        ...
        if x_diff_train_hist is not None:
        ...
        if obj_diff_train_hist is not None:
        ...
        if obj_diff_test_hist is not None:
