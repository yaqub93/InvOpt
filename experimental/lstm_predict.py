...
model_name_json = 'dataset/models/samso_model_linear_100ep_2024-04-08-13-20.json'        # if false, specify filename here
model_name_h5 = 'dataset/models/samso_model_linear_100ep_2024-04-08-13-20.h5'          # if false, specify filename here

import pickle

# Open the pickle file in binary read mode ('rb')
with open('dataset/filtered_samso_lstm1.pkl', 'rb') as f:
...
with open('prediction_100ep_2024-04-08-13-20.pkl', 'wb') as f:
...
plt.hist(y_test[:,1], bins = 100, label = "testing_data_1",alpha=0.5)
plt.hist(error[:,1], bins = 100, label = "error",alpha=0.5)
plt.legend() 
plt.grid()
plt.show()